...
import * as strings from 'SplitMergeWebPartStrings';
import SplitMerge from './components/SplitMerge';
import { ISplitMergeProps } from './components/ISplitMergeProps';

export interface ISplitMergeWebPartProps {
  title: string;
...
export default class SplitMergeWebPart extends BaseClientSideWebPart<ISplitMergeWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISplitMergeProps> = React.createElement(
        SplitMerge,
      {
        ...
        sourceLibraryTitle: this.properties.sourceLibraryTitle,
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyPaneTextField('sourceLibraryTitle', {
                  label: 'Source Library Title'
                }),
                PropertyPaneTextField('destinationLibraryTitle', {
                  label: 'Merged Library Title'
                }),
                PropertyPaneTextField('destinationDocumentRepositoryTitle', {
                  label: 'Destination Document Repository Title'
                }),
